...
func TestLoadConfigMissing(t *testing.T) {
	...
	test.Error(t, err)
	test.EqOp(t, "required key MATRIX_ALERTMANAGER_GO_CONFIGOPTIONFOO missing value", err.Error())
}
...
func TestLoadConfigAdditional(t *testing.T) {
	...
	test.Error(t, err)
	test.EqOp(t, "unknown environment variable MATRIX_ALERTMANAGER_GO_SOMEOTHEROPTION", err.Error())
}
...
func TestGetUsage(t *testing.T) {
	...
	expectedVars := []Variable{
		{
			Name:        "MATRIX_ALERTMANAGER_GO_CONFIGOPTIONFOO",
			Type:        "Integer",
			Default:     "",
			Required:    true,
		...
		{
			Name:        "MATRIX_ALERTMANAGER_GO_CONFIG_OPTION_BAR",
			Type:        "String",
			Default:     "stringA",
			Required:    false,
		...
		{
			Name:        "MATRIX_ALERTMANAGER_GO_LOG_LEVEL",
			Type:        "Level",
			Default:     "Info",
			Required:    false,
		...
		{
			Name:        "MATRIX_ALERTMANAGER_GO_SUB_CONFIG_CONFIG_OPTION_FOO_BAR",
			Type:        "True or False",
			Default:     "",
			Required:    false,
